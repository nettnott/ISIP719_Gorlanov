...
public class Game
{
    ...
    private Enemy CreateEnemy()
    {
        if (hod % 10 == 0)
        {
            ...
            { 
                case 0 :
                new VVG(100, random.Next(3, 100), random.Next(3, 100), "VVG python king");
                break;
                case 1 :
                new Kovalski(100, random.Next(3, 100), random.Next(3, 100), "Kovalski");
                break;
                case 2 :
                new ArkhimagCplusplus(100, random.Next(3, 100), random.Next(3, 100), "onet c++");
                break;
                case 3 :
                new PestovCminusminus(100, random.Next(3, 100), random.Next(3, 100), "onet c--");
                break;
            };
        }
        ...
        {
            case 0:
                new Goblin(100, random.Next(3, 100), random.Next(3, 100), "Goblin");
                break;
            case 1:
                new Skelet(100, random.Next(3, 100), random.Next(3, 100), "Skelet");
                break;
            case 2:
                new Mag(100, random.Next(3, 100), random.Next(3, 100), "Mag");
                break;
        };
    }
